...
void set_to_speaker()
{
    tinymix_set_value_byname(mixer,"AIF1IN0R Mux", "AIF1_DA0R");
    tinymix_set_value_byname(mixer,"AIF1IN0L Mux", "AIF1_DA0L");
    ...
    tinymix_set_value_byname(mixer,"SPK_L Mux","MIXEL Switch");
    tinymix_set_value_byname(mixer,"SPK_R Mux","MIXER Switch");
...
void set_to_jack()
{
	...
	tinymix_set_value_byname(mixer,"HP_R Mux", "DACR HPR Switch");
	tinymix_set_value_byname(mixer,"HP_L Mux", "DACL HPL Switch");
