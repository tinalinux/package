                                       ...
                                       OMX_IN OMX_PTR pParamData)
{
    ...
    switch(eParamIndex)
    {
        ...
        case OMX_IndexParamStandardComponentRole:
        {
            ...
            else if(!strncmp((char*)m_cName, "OMX.allwinner.audio.decoder.ac3",
                     OMX_MAX_STRINGNAME_SIZE))
            {
                if(!strncmp((const char*)comp_role->cRole,"audio_decoder.ac3",
                    OMX_MAX_STRINGNAME_SIZE))
                {
                    strncpy((char*)m_cRole,"audio_decoder.ac3",OMX_MAX_STRINGNAME_SIZE);
                }
                                             ...
                                             OMX_IN  OMX_U32        uIndex)
{
             ...
             OMX_MAX_STRINGNAME_SIZE))
    {
        if((0 == uIndex) && pRole)
        {
            strncpy((char *)pRole, "audio_decoder.ac3", OMX_MAX_STRINGNAME_SIZE);
            logi("component_role_enum: pRole %s\n", pRole);
        }
        else
        {
