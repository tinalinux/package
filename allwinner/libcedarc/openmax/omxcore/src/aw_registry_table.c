...
#define OMX_VDEC_LIB_NAME  "libcdc_omxil_vdec.so"
#define OMX_VENC_LIB_NAME  "libcdc_omxil_venc.so"
#define OMX_ADEC_LIB_NAME  "libcdc_omxil_adec.so"
...
const unsigned int NUM_OF_CORE = sizeof(core) / sizeof(omx_core_cb_type);
