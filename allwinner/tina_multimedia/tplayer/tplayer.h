...
{
    VIDEO_SCALE_DOWN_1      = 0, /*no scale down*/
    VIDEO_SCALE_DOWN_2      = 1, /*scale down 1/2*/
    VIDEO_SCALE_DOWN_4      = 2, /*scale down 1/4*/
    VIDEO_SCALE_DOWN_8      = 3, /*scale down 1/8*/
}TplayerVideoScaleDownType;

typedef enum TplayerVideoRotateType
{
    VIDEO_ROTATE_DEGREE_0        = 0, /*no rotate*/
    VIDEO_ROTATE_DEGREE_90       = 1, /*rotate 90 degree clockwise*/
    VIDEO_ROTATE_DEGREE_180      = 2, /*rotate 180 degree clockwise*/
    VIDEO_ROTATE_DEGREE_270      = 3, /*rotate 270 degree clockwise*/
