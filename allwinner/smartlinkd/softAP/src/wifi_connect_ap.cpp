 ...
 * ap passwd
 */
int smartlink_softAP_connect_ap(char *smartlink_softAP_ssid, char *smartlink_softAP_password){
	//int smartlink_softAP_connect_ap(){
	//char *smartlink_ssid = "12345678";
	//char *smartlink_password = "12345678";
	...
	p_wifi_interface->connect_ap(smartlink_softAP_ssid, smartlink_softAP_password, event_label);
